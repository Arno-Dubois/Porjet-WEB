...
export const searchInput = () => document.querySelector(".search-container div > input");
export const searchButton = () => document.querySelector(".search-container div > button");
export const searchResultsDropdown = () => document.querySelector(".search-results-dropdown");
export const searchFilters = () => document.querySelector(".search-filters");
export const searchNoResults = () => document.querySelector(".search-no-results");
export const searchResultItems = () => document.querySelectorAll(".search-result-item");
...
export const filmographyContainer = () => document.querySelector(".focus-container .actors");
